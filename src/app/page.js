  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
     <div className='flex flex-col justify-center mt-9 items-center'>
           ...
           <h1 className='text-[green] font-sans font-bold text-md'> <span className='text-[orange] underline italic  '>Donate</span> something or give your sister this contact</h1>
